...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php URL_BASE ?>assets/css/style.css">
		<link rel="stylesheet" type="text/css" href="<?php URL_BASE ?>assets/css/auxiliar.css">
		<link rel="stylesheet" type="text/css" href="<?php URL_BASE ?>assets/css/grade.css">
		<link rel="stylesheet" type="text/css" href="<?php URL_BASE ?>assets/css/m-style.css">
		 
		<script type="text/javascript" src="<?php URL_BASE ?>assets/js/jquery-3.3.1.min.js"></script>
		<script type="text/javascript" src="<?php URL_BASE ?>assets/js/js.js"></script>
		
	</head>
<body class="base-login">
	<div class="caixa-login position-relative">
		<img src="<?php URL_BASE ?>assets/img/img-topo-login.png">
